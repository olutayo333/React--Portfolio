    ...
    <div className='container-fluid '>
      ...
      <div className='row justify-content-center shadow bg-dark text-white mx-1 my-1 animate__animated animate__zoomIn animate_slower  '> 
        ...
        <div className='col-lg-5'>
          ...
          {/* SKILLS */}
      <div className='animate__animated animate__zoomIn animate__delay-2s animate_slower'>  
      <p className='fs-2 ms-5 mt-3 mb-5' style={{letterSpacing:"10px",  borderBottom:"3px solid #646CFF", width:"16vw"}}> <b>My Skills</b> </p>
      <div className=' row d-flex justify-content-center px-3 mx-2 mx-auto mb-2 row animate__animated animate__pulse animate__delay-2s  animate__infinite	infinite animate__slower	5s ' style={{}}>
      ...
      <div className='row bg-white text-dark d-flex justify-content-center mx-5 text-center my-5'>
          <div className='col-lg-4  rounded shadow animate__animated animate__rubberBand animate__delay-2s  animate__infinite	infinite animate__slower'>
              <h1 style={{letterSpacing:"20px"}}><b> 100+</b></h1> 
              <h5 style={{letterSpacing:"20px"}}><b>Projects Done </b></h5>
          </div>
      ...
      <div className='row animate__animated animate__zoomIn animate__delay-10s animate_slower' >
        ...
        <div className='row mx-1 px-1 py-3 my-2 d-flex text-white justify-content-center'>
          <div className='text-center col-lg-5 my-1 bg-dark rounded py-3 mx-1' style={{border:'2px solid black'}}>
          ...
          <div className='text-center  col-lg-5 my-1 bg-dark rounded py-3 mx-1'>
          ...
          <Link className=' text-center d-flex justify-content-center my-3' to='https://github.com/olutayo333?tab=repositories'> 
      ...
      <Link style={{borderBottom:"3px solid #646CFF"}} className='d-flex mx-auto justify-content-center mb-1 pb-3 w-100' to='https://www.linkedin.com/in/ayanrinde-olutayo-stephen/details/recommendations'>
        <button className='btn btn-lg btn-dark px-5 pt-3 animate__animated animate__pulse pt-1 animate__delay-2s  animate__infinite	infinite animate__slower' style={{color:"", letterSpacing:"12px"}}><b> <p className='animate__animated animate__flash animate__delay-2s  animate__infinite	infinite animate__slower'> View More Of My Recommendations </p> </b> </button>
      </Link>
      ...
      <div className='row d-flex justify-content-center bg-dark py-3 my-2 shadow'>  
        <div className='col-lg-10 mx-auto text-center ' style={{letterSpacing:"5px"}}>
        ...
        <div className='col-lg-10 mx-auto fs-1 text-center' >
